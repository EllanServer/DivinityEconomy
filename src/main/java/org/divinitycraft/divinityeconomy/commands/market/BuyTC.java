        ...
        switch (args.length) {
            ...
            case 3 -> {
                ...
                if (marketableMaterial != null) {
                    ...
                    value = String.format("%s", getMain().getConsole().formatMoney(marketableMaterial.getManager().calculatePrice(marketableMaterial, amount, marketableMaterial.getManager().getBuyScale(), true)));
                }
