...
public enum Setting {
    ...
    SECTION_MARKET_ENTITIES(SECTION_MARKET.path + ".Entities"),
    SECTION_MARKET_POTIONS(SECTION_MARKET.path + ".Potions"),
    ...
    MARKET_MATERIALS_BUY_TAX_FLOAT(SECTION_MARKET_MATERIALS.path + ".Buy Scaling"),
    MARKET_MATERIALS_SELL_TAX_FLOAT(SECTION_MARKET_MATERIALS.path + ".Sell Scaling"),
    MARKET_MATERIALS_PRICING_MODEL_STRING(SECTION_MARKET_MATERIALS.path + ".Pricing Model"),
    ...
    MARKET_ENTITIES_ENABLE_BOOLEAN(SECTION_MARKET_ENTITIES.path + ".Enable"),
    MARKET_ENTITIES_BASE_QUANTITY_INTEGER(SECTION_MARKET_ENTITIES.path + ".Base Quantity"),
    MARKET_ENTITIES_BUY_TAX_FLOAT(SECTION_MARKET_ENTITIES.path + ".Buy Scaling"),
    MARKET_ENTITIES_SELL_TAX_FLOAT(SECTION_MARKET_ENTITIES.path + ".Sell Scaling"),
    MARKET_ENTITIES_PRICING_MODEL_STRING(SECTION_MARKET_ENTITIES.path + ".Pricing Model"),
    MARKET_ENTITIES_WHOLE_MARKET_INF_BOOLEAN(SECTION_MARKET_ENTITIES.path + ".Whole Market Inflation"),
    MARKET_ENTITIES_ITEM_DMG_SCALING_BOOLEAN(SECTION_MARKET_ENTITIES.path + ".Item Damage Scaling"),
    MARKET_ENTITIES_IGNORE_NAMED_ITEMS_BOOLEAN(SECTION_MARKET_ENTITIES.path + ".Ignore Named Items"),

    MARKET_POTIONS_ENABLE_BOOLEAN(SECTION_MARKET_POTIONS.path + ".Enable"),
    MARKET_POTIONS_BASE_QUANTITY_INTEGER(SECTION_MARKET_POTIONS.path + ".Base Quantity"),
    MARKET_POTIONS_BUY_TAX_FLOAT(SECTION_MARKET_POTIONS.path + ".Buy Scaling"),
    MARKET_POTIONS_SELL_TAX_FLOAT(SECTION_MARKET_POTIONS.path + ".Sell Scaling"),
    MARKET_POTIONS_PRICING_MODEL_STRING(SECTION_MARKET_POTIONS.path + ".Pricing Model"),
    MARKET_POTIONS_WHOLE_MARKET_INF_BOOLEAN(SECTION_MARKET_POTIONS.path + ".Whole Market Inflation"),
    MARKET_POTIONS_ITEM_DMG_SCALING_BOOLEAN(SECTION_MARKET_POTIONS.path + ".Item Damage Scaling"),
    MARKET_POTIONS_IGNORE_NAMED_ITEMS_BOOLEAN(SECTION_MARKET_POTIONS.path + ".Ignore Named Items"),
    ...
    MARKET_ENCHANTS_BUY_TAX_FLOAT(SECTION_MARKET_ENCHANTS.path + ".Buy Scaling"),
    MARKET_ENCHANTS_SELL_TAX_FLOAT(SECTION_MARKET_ENCHANTS.path + ".Sell Scaling"),
    MARKET_ENCHANTS_PRICING_MODEL_STRING(SECTION_MARKET_ENCHANTS.path + ".Pricing Model"),
    ...
    MARKET_EXP_BUY_TAX_FLOAT(SECTION_MARKET_EXP.path + ".Buy Scaling"),
    MARKET_EXP_SELL_TAX_FLOAT(SECTION_MARKET_EXP.path + ".Sell Scaling"),
    MARKET_EXP_PRICING_MODEL_STRING(SECTION_MARKET_EXP.path + ".Pricing Model"),
